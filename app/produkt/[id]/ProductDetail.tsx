...
const productInfo: Record<string, Record<string, { usage: string; examples: string[] }>> = {
  de: {
    ...
    'spotify-30': { usage: 'Spotify Premium Guthaben schenkt dir werbefreies Musik-Streaming. Einlösbar für Spotify Premium Abos.', examples: ['Spotify Premium Individual', 'Spotify Duo', 'Spotify Family', 'Spotify Student'] },
